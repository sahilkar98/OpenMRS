...
public class CaptureVitals extends WebDriverWrapper {

	@Test(dataProvider = "validCredentialData",dataProviderClass = DataProviderUtils.class)
	public void searchCapturevitalsByNametest(String username, String password) throws InterruptedException {
		...
		oc.searchAndClickonPatientByNameInCaptureVitals();
		oc.captureVitalsMethod();
	}
}
